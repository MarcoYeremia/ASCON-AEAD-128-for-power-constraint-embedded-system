set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NETLIST) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/06-yosys-synthesis/ascon_top.nl.v
set ::env(SAVE_ODB) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/13-openroad-floorplan/ascon_top.odb
set ::env(SAVE_DEF) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/13-openroad-floorplan/ascon_top.def
set ::env(SAVE_SDC) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/13-openroad-floorplan/ascon_top.sdc
set ::env(SAVE_NETLIST) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/13-openroad-floorplan/ascon_top.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/13-openroad-floorplan/ascon_top.pnl.v
