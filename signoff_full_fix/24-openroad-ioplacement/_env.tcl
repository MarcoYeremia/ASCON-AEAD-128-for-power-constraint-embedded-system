...
set ::env(CURRENT_ODB) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/23-openroad-globalplacementskipio/ascon_top.odb
set ::env(SAVE_ODB) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/24-openroad-ioplacement/ascon_top.odb
set ::env(SAVE_DEF) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/24-openroad-ioplacement/ascon_top.def
set ::env(SAVE_SDC) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/24-openroad-ioplacement/ascon_top.sdc
set ::env(SAVE_NETLIST) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/24-openroad-ioplacement/ascon_top.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/24-openroad-ioplacement/ascon_top.pnl.v
