...
set ::env(CURRENT_DEF) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/52-odb-cellfrequencytables/ascon_top.def
...
set ::env(SAVE_SPEF) /foss/designs/ascon_top_layout/runs/RUN_2026-08-21_17-20-50/53-openroad-rcx/min/ascon_top.min.spef
