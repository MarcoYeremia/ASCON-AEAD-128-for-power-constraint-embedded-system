set ::env(FP_PDN_CFG) /usr/local/lib/python3.12/dist-packages/openlane/scripts/openroad/common/pdn_cfg.tcl
...
set ::env(CURRENT_ODB) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/18-openroad-tapendcapinsertion/ascon_top.odb
set ::env(SAVE_ODB) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/20-openroad-generatepdn/ascon_top.odb
set ::env(SAVE_DEF) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/20-openroad-generatepdn/ascon_top.def
set ::env(SAVE_SDC) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/20-openroad-generatepdn/ascon_top.sdc
set ::env(SAVE_NETLIST) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/20-openroad-generatepdn/ascon_top.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/20-openroad-generatepdn/ascon_top.pnl.v
