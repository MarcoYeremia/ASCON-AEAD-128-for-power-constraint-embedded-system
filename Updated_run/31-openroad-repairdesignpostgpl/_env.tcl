set ::env(RSZ_CORNER_0) "nom_tt_025C_5v00 /foss/pdks/gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu7t5v0/lib/gf180mcu_fd_sc_mcu7t5v0__tt_025C_5v00.lib"
set ::env(RSZ_CORNER_1) "nom_ss_125C_4v50 /foss/pdks/gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu7t5v0/lib/gf180mcu_fd_sc_mcu7t5v0__ss_125C_4v50.lib"
set ::env(RSZ_CORNER_2) "nom_ff_n40C_5v50 /foss/pdks/gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu7t5v0/lib/gf180mcu_fd_sc_mcu7t5v0__ff_n40C_5v50.lib"
...
set ::env(MAX_TRANSITION_CONSTRAINT) 4.0
...
set ::env(DESIGN_NAME) ascon_top
set ::env(CLOCK_PERIOD) 20.0
set ::env(CLOCK_PORT) clk
set ::env(DIE_AREA) "0 0 1110 1110"
set ::env(FALLBACK_SDC_FILE) /usr/local/lib/python3.12/dist-packages/openlane/scripts/base.sdc
set ::env(PDN_CONNECT_MACROS_TO_GRID) 1
set ::env(PDN_ENABLE_GLOBAL_CONNECTIONS) 1
set ::env(FP_DEF_TEMPLATE) /foss/designs/ascon/A68_A.def
...
set ::env(CURRENT_ODB) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/27-openroad-globalplacement/ascon_top.odb
set ::env(SAVE_ODB) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/31-openroad-repairdesignpostgpl/ascon_top.odb
set ::env(SAVE_DEF) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/31-openroad-repairdesignpostgpl/ascon_top.def
set ::env(SAVE_SDC) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/31-openroad-repairdesignpostgpl/ascon_top.sdc
set ::env(SAVE_NETLIST) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/31-openroad-repairdesignpostgpl/ascon_top.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/31-openroad-repairdesignpostgpl/ascon_top.pnl.v
