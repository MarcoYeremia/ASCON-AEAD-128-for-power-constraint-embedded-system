...
set ::env(CURRENT_ODB) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/41-openroad-repairantennas/1-diodeinsertion/ascon_top.odb
set ::env(SAVE_ODB) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/43-openroad-detailedrouting/ascon_top.odb
set ::env(SAVE_DEF) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/43-openroad-detailedrouting/ascon_top.def
set ::env(SAVE_SDC) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/43-openroad-detailedrouting/ascon_top.sdc
set ::env(SAVE_NETLIST) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/43-openroad-detailedrouting/ascon_top.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/43-openroad-detailedrouting/ascon_top.pnl.v
