set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NETLIST) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/06-yosys-synthesis/ascon_top.nl.v
set ::env(SAVE_ODB) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/13-openroad-floorplan/ascon_top.odb
set ::env(SAVE_DEF) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/13-openroad-floorplan/ascon_top.def
set ::env(SAVE_SDC) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/13-openroad-floorplan/ascon_top.sdc
set ::env(SAVE_NETLIST) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/13-openroad-floorplan/ascon_top.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/13-openroad-floorplan/ascon_top.pnl.v
