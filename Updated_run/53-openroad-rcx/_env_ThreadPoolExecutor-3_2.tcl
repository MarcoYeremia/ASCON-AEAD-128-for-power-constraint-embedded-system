...
set ::env(RCX_RULESETS) "\"nom_*\" /foss/pdks/gf180mcuD/libs.tech/openlane/rules.openrcx.gf180mcuD.nom \"min_*\" /foss/pdks/gf180mcuD/libs.tech/openlane/rules.openrcx.gf180mcuD.min \"max_*\" /foss/pdks/gf180mcuD/libs.tech/openlane/rules.openrcx.gf180mcuD.max"
set ::env(CURRENT_DEF) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/52-odb-cellfrequencytables/ascon_top.def
set ::env(RCX_LEF) /foss/pdks/gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu7t5v0/techlef/gf180mcu_fd_sc_mcu7t5v0__max.tlef
set ::env(RCX_RULESET) /foss/pdks/gf180mcuD/libs.tech/openlane/rules.openrcx.gf180mcuD.max
set ::env(SAVE_SPEF) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/53-openroad-rcx/max/ascon_top.max.spef
