...
set ::env(RCX_RULESET) /foss/pdks/gf180mcuD/libs.tech/openlane/rules.openrcx.gf180mcuD.nom
set ::env(SAVE_SPEF) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/53-openroad-rcx/nom/ascon_top.nom.spef
