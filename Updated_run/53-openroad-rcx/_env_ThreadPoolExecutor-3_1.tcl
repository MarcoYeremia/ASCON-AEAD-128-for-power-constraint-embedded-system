...
set ::env(RCX_LEF) /foss/pdks/gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu7t5v0/techlef/gf180mcu_fd_sc_mcu7t5v0__min.tlef
set ::env(RCX_RULESET) /foss/pdks/gf180mcuD/libs.tech/openlane/rules.openrcx.gf180mcuD.min
set ::env(SAVE_SPEF) /foss/designs/ascon/runs/RUN_2026-09-05_03-04-29/53-openroad-rcx/min/ascon_top.min.spef
